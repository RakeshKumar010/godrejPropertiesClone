...
import ClickHere from "../../assets/image/clickheregif.gif";
    ...
    <div className="md:p-10 my-10 relative border-2" ref={download}>
      <div className="flex flex-col   items-center gap-4 justify-center">
        ...
        <p className="text-center">
          Know more about where your future lies. Download the product kit now.
        </p>
        <div
          className="flex items-center mb-10 text-lg cursor-pointer gap-2 font-semibold"
          onClick={() => {
            setIsOpen(true);
          }}
        >
